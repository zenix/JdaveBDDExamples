...
public class MmlOneLinerService implements MmlService {

    private final MmlClient telnetClient;

    public MmlOneLinerService(final MmlClient telnetClient) {

        this.telnetClient = telnetClient;
    }

    public void send(final CustomerDTO customerDTO) {
        final MmlCreator mmlCreator = createMmlCreator();
